...
import type { MojoAction, RenderOptions, ValidatorFunction } from './types.js';
...
declare class Context extends EventEmitter {
     ...
     */
    redirectTo(target: string, options?: {
        status?: number;
     ...
     */
    respondTo(spec: Record<string, MojoAction>): Promise<void>;
    /**
     * Send static file.
     */
