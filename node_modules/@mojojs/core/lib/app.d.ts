...
import type { AnyArguments, AppOptions, UserAgentOptions, MojoAction, MojoContext, RouteArguments, ServerOptions, TestUserAgentOptions } from './types.js';
...
export declare type Decoration = ((...args: any[]) => any) | {
    get?: () => any;
    set?: (value: any) => any;
};
export declare type Plugin = (app: App, options: Record<string, any>) => any;
/**
 * Application class.
 */
