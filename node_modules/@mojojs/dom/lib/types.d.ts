...
export declare type Child = CommentNode | CDATANode | DoctypeNode | ElementNode | FragmentNode | PINode | TextNode;
export declare type Parent = DocumentNode | ElementNode | FragmentNode;
